			...
			<script src="functions/class_formValidation.js"></script>
			<script src="functions/class_regex_restriction.js"></script>
			<script src="functions/new_class_function.js"></script>
			...
			<?php include 'functions/class_formhandling.php'; ?>
