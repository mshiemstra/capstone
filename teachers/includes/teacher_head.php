			...
			<script src="functions/teacher_regex_restriction.js"></script>
			<script src="functions/new_teacher_function.js"></script>
			...
			<?php include 'functions/teacher_formhandling.php'; ?>
